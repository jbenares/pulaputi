    ...
    <x-header />
        ...
        @foreach($mayors AS $my)
            ...
            <h2 id="accordion-color-heading-{{ $count }}">
                ...
                <span class='text-xs text-green-400'>Bets Today: {{ getBetsToday($my->id) }}, Bets this Month: {{ getBetsMonth($my->id) }}</span>
                <span class='text-xs text-green-400'>Total Wins: {{ getTotalWins($my->id) }}</span>
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th scope="col" class="px-5 py-3 text-xs font-normal text-left text-gray-800 bg-green-100 border-b border-gray-200">
                                    Total Wins: {{ getTotalWins($cor->id) }}
