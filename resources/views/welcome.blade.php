                    ...
                    <div class="flex items-center justify-between py-6 border-gray-100 md:space-x-10">
                        <div class="flex items-center justify-start gap-12">
                            <a class="flex items-center" href="/">
                                <img class="w-auto h-12 sm:h-12" src="/images/phaklogo.png" alt="PhakBet"/>
                ...
                <div class="flex flex-col items-start justify-between w-full h-full md:flex-row md:justify-start md:h-1/2">
                    <div class="z-20 flex flex-col items-center justify-start w-full h-full text-left md:z-30 md:w-1/2 md:items-start md:justify-center">
                        ...
                        <h2 class="mt-3 text-lg text-gray-500 sm:mt-5 sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                            PhakBet gives you access to bet on  
                            <span class="font-bold text-gray-700">
                                multiple events
                            </span>
                            being ran nationwide for just ₱10 per bet.
                        </h2>
                        <div class="w-full mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                            <div class="mt-3 sm:mt-0 sm:ml-3">
                                <a  href="{{ route('login_phakbet') }}"  rel="noreferrer" class="flex items-center justify-center w-full px-4 px-8 py-2 py-3 text-base font-medium text-gray-800  bg-blue-500 rounded-md hover:bg-gray-200">
                            ...
                            <!-- <div class="mt-3 sm:mt-0 sm:ml-3">
                                <a  href="{{ route('login') }}"  rel="noreferrer" class="flex items-center justify-center w-full px-4 px-8 py-2 py-3 text-base font-medium text-gray-800  bg-blue-200 rounded-md hover:bg-gray-200">
                        ...
                        <br />
                        <h3 class="mt-3 text-lg text-gray-500 sm:mt-5 sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">Please note that we are currenty in our <font color="red"><b><u>BETA TEST</u></b></font> phase. As such, registration is disabled.</h3>
